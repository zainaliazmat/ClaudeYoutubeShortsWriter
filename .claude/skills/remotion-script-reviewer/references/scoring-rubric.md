...
| 5 | **Audio Sync** | 10 | Track vibe specified; mix note (music under captions); every SFX has a frame number matching a visual event. If the script has no audio at all, score on intent — don't penalize a deliberate silent piece, but note it. |
