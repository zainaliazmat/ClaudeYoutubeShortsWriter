...
import { Hook, Beat1, Beat2, Beat3, Beat4, Beat5, Beat6, LoopBack } from "./scenes";
...
export const Short: React.FC<ShortProps> = ({ audio }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bgTop }}>
      ...
      <Sequence from={SCENES.beat1.from} durationInFrames={SCENES.beat1.duration}><Beat1 /></Sequence>
      <Sequence from={SCENES.beat2.from} durationInFrames={SCENES.beat2.duration}><Beat2 /></Sequence>
